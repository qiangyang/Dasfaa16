...
public class SpiderWorker3 implements Runnable{
	...
	private AnJuKeParser info;
	private DataStorage store;
	private int threadIndex;
	
	public SpiderWorker3(int threadIndex){
		this.threadIndex = threadIndex;
		this.fetcher = new PageFetcher();
		this.handler = new ContentHandler();
		this.info=new AnJuKeParser();
...
//			}
			...
			// 解析页面，获取目标数据
			try {
				AnJuKe targetData = info.parse(fetchedPage);
