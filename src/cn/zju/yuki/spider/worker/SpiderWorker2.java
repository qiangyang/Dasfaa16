...
import cn.zju.yuki.spider.parser.FiveEgithParser;
...
public class SpiderWorker2 implements Runnable{
	...
	private FiveEgithParser info;
	private DataStorage store;
	private int threadIndex;
	
	public SpiderWorker2(int threadIndex){
		this.threadIndex = threadIndex;
		this.fetcher = new PageFetcher();
		this.handler = new ContentHandler();
		this.info=new FiveEgithParser();
...
//			}
			...
			// 解析页面，获取目标数据
			try {
				FiveEight targetData = info.parse(fetchedPage);
